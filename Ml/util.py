...
#
        ...
        for clas in img_classes:
            # perform NMS

            # get the detections with one particular class
            clas_mask = image_pred_ * \
                (image_pred_[:, -1] == clas).float().unsqueeze(1)
            ...
            # Repeat the batch_id for as many detections of the class clas in the image
