...
HD_PWD='E:/Conception de systemes VLSI/Laboratoire 4/ZYBO_HDMI_MGA/project_1/project_1.runs/HDMI_bd_rgb2dvi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_bd_rgb2dvi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_bd_rgb2dvi_0_1.tcl
