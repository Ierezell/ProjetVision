...
entity detection_centre is
  ...
  attribute CORE_GENERATION_INFO of detection_centre : entity is "detection_centre,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=detection_centre,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=6,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of detection_centre : entity is "detection_centre.hwdef";
end detection_centre;

architecture Behavioral of detection_centre is
  ...
  component detection_centre_Ligne_counter_0 is
  port (
    CLK : in STD_LOGIC;
    CE : in STD_LOGIC;
    SCLR : in STD_LOGIC;
  ...
  end component detection_centre_Ligne_counter_0;
  ...
  component detection_centre_column_counter_0 is
  port (
    CLK : in STD_LOGIC;
    CE : in STD_LOGIC;
    SCLR : in STD_LOGIC;
  ...
  end component detection_centre_column_counter_0;
...
Ligne_counter: component detection_centre_Ligne_counter_0
     port map (
      CE => CE_ligne_count_1,
      CLK => CLK_1,
...
column_counter: component detection_centre_column_counter_0
     port map (
