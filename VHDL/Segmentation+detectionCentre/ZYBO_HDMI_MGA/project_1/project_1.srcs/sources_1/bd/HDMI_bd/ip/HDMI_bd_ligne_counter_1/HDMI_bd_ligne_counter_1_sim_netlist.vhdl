...
-- Date        : Sat Dec  1 17:33:23 2018
-- Host        : Nicolas running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/nicol/Documents/GitHub/ProjetVision/VHDL/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.srcs/sources_1/bd/HDMI_bd/ip/HDMI_bd_ligne_counter_1/HDMI_bd_ligne_counter_1_sim_netlist.vhdl
-- Design      : HDMI_bd_ligne_counter_1
...
entity HDMI_bd_ligne_counter_1_Counter is
  port (
  ...
  attribute ORIG_REF_NAME of HDMI_bd_ligne_counter_1_Counter : entity is "Counter";
end HDMI_bd_ligne_counter_1_Counter;

architecture STRUCTURE of HDMI_bd_ligne_counter_1_Counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity HDMI_bd_ligne_counter_1 is
  port (
    CLK : in STD_LOGIC;
    RESET : in STD_LOGIC;
    EN : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of HDMI_bd_ligne_counter_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of HDMI_bd_ligne_counter_1 : entity is "HDMI_bd_ligne_counter_1,Counter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of HDMI_bd_ligne_counter_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of HDMI_bd_ligne_counter_1 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of HDMI_bd_ligne_counter_1 : entity is "Counter,Vivado 2018.2";
end HDMI_bd_ligne_counter_1;

architecture STRUCTURE of HDMI_bd_ligne_counter_1 is
...
begin
U0: entity work.HDMI_bd_ligne_counter_1_Counter
     port map (
      CLK => CLK,
      EN => EN,
      RESET => RESET,
