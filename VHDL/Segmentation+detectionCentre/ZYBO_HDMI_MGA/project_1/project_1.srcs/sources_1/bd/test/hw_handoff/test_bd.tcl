...
proc create_root_design { parentCell } {
  ...
  set dividende [ create_bd_port -dir I -from 15 -to 0 dividende ]
  set divisor [ create_bd_port -dir I -from 15 -to 0 divisor ]
  set sortie [ create_bd_port -dir O -from 39 -to 0 sortie ]
  set sortie_ok [ create_bd_port -dir O sortie_ok ]
  ...
  connect_bd_net -net adapt_input_ouput_0_sortie [get_bd_pins adapt_input_ouput_0/sortie] [get_bd_pins div_gen_0/s_axis_dividend_tdata]
  connect_bd_net -net div_gen_0_m_axis_dout_tdata [get_bd_ports sortie] [get_bd_pins div_gen_0/m_axis_dout_tdata]
  connect_bd_net -net div_gen_0_m_axis_dout_tvalid [get_bd_ports sortie_ok] [get_bd_pins div_gen_0/m_axis_dout_tvalid]
  connect_bd_net -net dividende_1 [get_bd_ports dividende] [get_bd_pins adapt_input_ouput_0/entree]
  connect_bd_net -net divisor_1 [get_bd_ports divisor] [get_bd_pins div_gen_0/s_axis_divisor_tdata]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins div_gen_0/s_axis_dividend_tvalid] [get_bd_pins div_gen_0/s_axis_divisor_tvalid] [get_bd_pins xlconstant_0/dout]
