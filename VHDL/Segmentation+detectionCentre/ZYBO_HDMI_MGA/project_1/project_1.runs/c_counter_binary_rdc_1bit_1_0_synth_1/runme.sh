...
HD_PWD='C:/Users/NMLEM1/Desktop/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/c_counter_binary_rdc_1bit_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_counter_binary_rdc_1bit_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_counter_binary_rdc_1bit_1_0.tcl
