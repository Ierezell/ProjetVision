...
HD_PWD='E:/VLSI/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/c_counter_binary_ligne_counter_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_counter_binary_ligne_counter_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_counter_binary_ligne_counter_1.tcl
