...
HD_PWD='C:/Users/NMLEM1/Desktop/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/TEST2_ligne_counter1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST2_ligne_counter1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST2_ligne_counter1_0.tcl
