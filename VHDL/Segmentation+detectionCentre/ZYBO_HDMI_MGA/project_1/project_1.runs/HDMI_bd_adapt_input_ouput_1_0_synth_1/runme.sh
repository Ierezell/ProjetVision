...
HD_PWD='E:/VLSI/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/HDMI_bd_adapt_input_ouput_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_bd_adapt_input_ouput_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_bd_adapt_input_ouput_1_0.tcl
