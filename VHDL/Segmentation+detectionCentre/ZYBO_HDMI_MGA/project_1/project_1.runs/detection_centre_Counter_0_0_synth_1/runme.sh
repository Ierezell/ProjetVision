...
HD_PWD='E:/VLSI/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/detection_centre_Counter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log detection_centre_Counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source detection_centre_Counter_0_0.tcl
