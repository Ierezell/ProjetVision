...
HD_PWD='E:/VLSI/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/HDMI_bd_divideur_select_outp_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_bd_divideur_select_outp_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_bd_divideur_select_outp_0_2.tcl
