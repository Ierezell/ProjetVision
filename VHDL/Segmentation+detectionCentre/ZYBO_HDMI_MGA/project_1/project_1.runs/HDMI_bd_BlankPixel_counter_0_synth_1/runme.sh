...
HD_PWD='E:/VLSI/Projet/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/HDMI_bd_BlankPixel_counter_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_bd_BlankPixel_counter_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_bd_BlankPixel_counter_0.tcl
