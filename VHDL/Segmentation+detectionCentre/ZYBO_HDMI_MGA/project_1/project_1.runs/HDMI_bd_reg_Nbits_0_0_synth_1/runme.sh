...
HD_PWD='C:/Users/NMLEM1/Desktop/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/HDMI_bd_reg_Nbits_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_bd_reg_Nbits_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_bd_reg_Nbits_0_0.tcl
