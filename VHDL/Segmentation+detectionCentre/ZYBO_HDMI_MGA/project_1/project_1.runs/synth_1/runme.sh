...
HD_PWD='D:/nicol/Documents/GitHub/ProjetVision/VHDL/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_counter_binary_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_counter_binary_wrapper.tcl
