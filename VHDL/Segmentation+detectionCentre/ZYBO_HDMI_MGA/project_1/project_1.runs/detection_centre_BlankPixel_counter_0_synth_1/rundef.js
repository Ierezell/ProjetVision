...
ISEStep( "vivado",
         "-log detection_centre_BlankPixel_counter_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source detection_centre_BlankPixel_counter_0.tcl" );
