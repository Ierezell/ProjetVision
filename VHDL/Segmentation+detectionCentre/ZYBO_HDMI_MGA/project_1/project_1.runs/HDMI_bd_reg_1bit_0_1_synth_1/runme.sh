...
HD_PWD='C:/Users/NMLEM1/Desktop/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/HDMI_bd_reg_1bit_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_bd_reg_1bit_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_bd_reg_1bit_0_1.tcl
