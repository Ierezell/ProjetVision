...
HD_PWD='D:/nicol/Documents/GitHub/ProjetVision/VHDL/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/HDMI_bd_ligne_counter_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_bd_ligne_counter_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_bd_ligne_counter_1.tcl
