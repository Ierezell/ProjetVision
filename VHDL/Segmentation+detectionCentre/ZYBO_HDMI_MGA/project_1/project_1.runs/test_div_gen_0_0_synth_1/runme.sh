...
HD_PWD='D:/nicol/Documents/GitHub/ProjetVision/VHDL/Segmentation+detectionCentre/ZYBO_HDMI_MGA/project_1/project_1.runs/test_div_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_div_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_div_gen_0_0.tcl
