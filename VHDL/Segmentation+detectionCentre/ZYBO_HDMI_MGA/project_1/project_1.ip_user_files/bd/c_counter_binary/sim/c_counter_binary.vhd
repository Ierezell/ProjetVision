...
-- ce bloc est le plus a jour
  ...
  attribute core_generation_info of c_counter_binary : entity is "c_counter_binary,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=c_counter_binary,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=19,numReposBlks=19,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=16,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}";
...
architecture STRUCTURE of c_counter_binary is
  ...
  component c_counter_binary_reg_Nbits_0_0 is
  port (
  ...
  end component c_counter_binary_reg_Nbits_0_0;
  component c_counter_binary_reg_Nbits_0_1 is
  port (
    D : in STD_LOGIC_VECTOR ( 17 downto 0 );
    CLK : in STD_LOGIC;
    RESET : in STD_LOGIC;
  ...
  end component c_counter_binary_reg_Nbits_0_1;
...
reg_Nbits_0: component c_counter_binary_reg_Nbits_0_0
     port map (
      CLK => CLK_1,
...
reg_Nbits_1: component c_counter_binary_reg_Nbits_0_1
     port map (
      CLK => CLK_1,
