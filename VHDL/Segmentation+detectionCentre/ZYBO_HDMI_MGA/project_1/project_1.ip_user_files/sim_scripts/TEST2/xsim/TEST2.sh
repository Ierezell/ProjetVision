...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xlconstant_v1_1_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TEST2 xil_defaultlib.TEST2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TEST2 -key {Behavioral:sim_1:Functional:TEST2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TEST2.wdb xsim.dir)
