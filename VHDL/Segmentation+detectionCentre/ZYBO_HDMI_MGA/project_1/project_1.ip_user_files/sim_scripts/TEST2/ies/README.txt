...
#
# Generated by export_simulation on Sat Dec 08 16:22:20 -0500 2018
#
################################################################################
...
'-reset_run' switch to the './TEST2.sh' script.
...
./TEST2.sh -noclean_files

For more information on the script, please type './TEST2.sh -help'.
