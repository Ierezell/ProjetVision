...
#
# Generated by export_simulation on Sun Dec 02 20:34:59 -0500 2018
#
################################################################################
...
'-reset_run' switch to the './c_counter_binary.sh' script.

./c_counter_binary.sh -reset_run
...
./c_counter_binary.sh -noclean_files

For more information on the script, please type './c_counter_binary.sh -help'.
