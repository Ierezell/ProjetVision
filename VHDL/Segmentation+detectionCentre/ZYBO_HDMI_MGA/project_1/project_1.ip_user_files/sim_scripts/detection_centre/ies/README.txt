...
#
# Generated by export_simulation on Fri Nov 30 15:14:28 -0500 2018
#
################################################################################
...
'-reset_run' switch to the './detection_centre.sh' script.

./detection_centre.sh -reset_run
...
./detection_centre.sh -noclean_files

For more information on the script, please type './detection_centre.sh -help'.
